...
import CreateGoodsForm from "@/components/forms/CreateGoodsForm";
...
const CreateGoodsPage: React.FC = () => {
  ...
  const handleCreateFinishedGood = async (data: FinishedGoodData): Promise<void> => {
    setLoading(true);
    setError("");
    setSuccess("");
    ...
    try {
      ...
      if (response.status === 200 || response.status === 201) {
        ...
        throw new Error(response.data?.message || "Failed to create finished good");
      }
    } catch (error: any) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto px-4">
        ...
        {/* Form */}
        <CreateGoodsForm onSubmit={handleCreateFinishedGood} loading={loading} />
