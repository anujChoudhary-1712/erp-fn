...
// TypeScript interface for machinery data, updated to match the new API response
interface Machinery {
    _id: string;
...
const MachineryPage = () => {
    ...
    // Refactored MachineryCard component
        ...
        >
            ...
            <div className="space-y-2 text-sm text-gray-600">
                <div className="flex items-center space-x-2">
                    ...
                    <span>Type: {machinery.machine_equipment_type}</span>
                </div>
                <div className="flex items-center space-x-2">
                ...
                <div className="flex items-center space-x-2">
                    ...
                    <span>Location: {machinery.location}</span>
                </div>
                <div className="flex items-center space-x-2">
                    <svg className="w-4 h-4 text-gray-500" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zM12 20c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"/></svg>
                    <span>Status: {machinery.status}</span>
                </div>
            </div>
        </div>
    )
