...
interface ProductionPlanData {
  plan_name: string;
  plan_type: "Monthly" | "Weekly" | "Daily" | "Custom";
  start_date: string;
  end_date: string;
    ...
    return (
      <div className="mb-6 sm:mb-8">
        ...
        <div className="flex justify-center mt-2">
          <div className="flex justify-between w-32 sm:w-64 text-xs sm:text-sm text-gray-600">
            <span
              className={
            ...
            <div className="space-y-4 sm:space-y-6">
              {productionPlan.production_items.map((item, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="p-3 sm:p-4 border border-gray-200 rounded-md bg-gray-50"
                  >
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-3 space-y-2 sm:space-y-0">
                      <div className="flex items-center">
                        <span className="flex items-center justify-center w-6 h-6 bg-blue-600 text-white rounded-full text-xs mr-2 flex-shrink-0">
                          {index + 1}
                        </span>
                        ...
                        <div className="mt-4">
                            ...
                            <div className="overflow-x-auto">
                              <table className="min-w-full divide-y divide-gray-200">
                                <thead className="bg-gray-100">
                                  <tr>
                                    <th className="px-4 py-2 text-xs font-medium text-gray-500 text-left">Material</th>
                                    <th className="px-4 py-2 text-xs font-medium text-gray-500 text-right">Required</th>
                                    <th className="px-4 py-2 text-xs font-medium text-gray-500 text-right">Available</th>
                                    <th className="px-4 py-2 text-xs font-medium text-gray-500 text-center">Status</th>
                                  </tr>
                                </thead>
                          ...
                          <div className="sm:hidden space-y-3">
                            {item.raw_materials.map((material, matIndex) => {
                              ...
                              return (
                                <div key={matIndex} className="bg-white border rounded-lg p-3">
                                  <div className="flex justify-between items-start mb-2">
                                    <h6 className="font-medium text-sm text-gray-900 flex-1 pr-2">
                                      {materialDetails?.material_name || "Unknown Material"}
                                    </h6>
                                    <span
                                  ...
                                  <div className="grid grid-cols-2 gap-2 text-xs text-gray-600">
                                    <div>
                                      <span className="font-medium">Required:</span> {material.quantity_required} {materialDetails?.unit}
                                    </div>
                                    <div>
                                      <span className="font-medium">Available:</span> {materialDetails?.current_stock} {materialDetails?.unit}
                                    </div>
                                  </div>
                                </div>
                              );
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        {loadingProducts ? (
          <div className="flex flex-col sm:flex-row items-center justify-center py-8 sm:py-12">
            ...
            <span className="text-gray-700 text-sm sm:text-base text-center">Loading product data...</span>
          </div>
        ) : (
          <div>
